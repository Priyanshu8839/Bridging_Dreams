...
$result = mysqli_query($con, "SELECT * FROM investor WHERE Email = '$Email'");
        ...
        if ($Password == $row["Password"]){
          ...
          $_SESSION["id"] = $row["id"];
           echo "<script>
            ...
            window.location.href='investor_index.php';
            </script>";
}
            else{
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="investor_login.php"> <i class="fa fa-user" aria-hidden="true"></i> Investor Login <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="entrepreneur_login.php"> <i class="fa fa-user" aria-hidden="true"></i> Entrepreneur Login</a>
              </li>
...
<div class="goyal">
  <section class="why_section layout_padding">
    <div class="main">
      <div class="cont a-cont" id="a-container">
        <form class="form" id="a-form" action="investor_Data.php" method="post" enctype="multipart/form-data">
          <h2 class="form_title title">Create Account For Investor</h2>
          ...
          <div>
            <input type="email" class="form__input1" placeholder="Email" name="Email" required>
            <button class="button1" type="button">Send OTP</button>
          </div>
          
            <input type="tel" class="form__input" placeholder="Mobile Number" name="Mobile" pattern="[0-9]{10}" inputmode="numeric" maxlength="10" required>

          <input type="password" class="form__input" placeholder="Password" name="Password" required>

          <input type="password" class="form__input" placeholder="Confirm Password" name="ConfirmPassword" required>

          <input type="text" class="form__input" placeholder="Company & Project Name" name="about" required>

          <label for="file-upload" class="image-button">Select Your Image</label>
          <input type="file" id="file-upload" name="file" class="file-input" onchange="displayFileName()">
          <span class="file-name" id="file-name">No file chosen</span>

          <button class="form__button button" value="Sumbit" type="submit">SIGN UP</button>
        </form>
      </div>



      <div class="cont b-cont" id="b-container">
        <form class="form" id="b-form" method="post" action="">
          ...
          <button class="form__button button" value="Sign_Patient" name="Sign" type="submit">SIGN IN</button>
        </form>
      </div>
