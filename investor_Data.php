...
$duplicate = mysqli_query($con, "SELECT * FROM investor WHERE Email = '$Email' OR Mobile = '$Mobile'");
if(mysqli_num_rows($duplicate) > 0){
    echo "<script> alert('Email or Mobile Number Has Already Taken'); </script>";
}
else{
if($Password == $ConfirmPassword){
    $query = "INSERT INTO investor VALUES('','".$Name."','".$Email."',".$Mobile.",'".$Password."','".$about."','".$file_name."')";
