...
if(!empty($_SESSION["id"])){
  $id = $_SESSION["id"];
  $result = mysqli_query($con, "SELECT * FROM entrepreneur WHERE id = $id");
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="entrepreneur_profile.php"> <i class="fa fa-user" aria-hidden="true"></i> Profile <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item">
                ...
                <div class="account-settings">
                    <div class="user-profile">
                        <div class="user-avatar">
                            <img src="entrepreneur_Image/<?php echo$row['entrepreneur_Image']; ?>" alt="user" class="rounded-circle" width="150">
                        </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-right">
                                    <a href="entrepreneur_profile.php" class="btn btn-secondary">Cancel</a>
...
$duplicate = mysqli_query($con, "SELECT * FROM entrepreneur WHERE Mobile = '$Mobile'");
if(mysqli_num_rows($duplicate) > 0){
    echo "<script> alert('Email or Mobile Number Has Already Exist'); </script>";
}
else{
if($Password == $ConfirmPassword){
    $query = "UPDATE entrepreneur set Name='".$Name."',Email='".$Email."',Password='".$Password."',about='".$about."',entrepreneur_Image='".$file_name."'";
