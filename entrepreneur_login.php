        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="investor_login.php"> <i class="fa fa-user" aria-hidden="true"></i> Investor Login</a>
              </li>
              <li class="nav-item active">
                <a class="nav-link" href="entrepreneur_login.php"> <i class="fa fa-user" aria-hidden="true"></i> Entrepreneur Login <span class="sr-only">(current)</span></a>
              </li>
  ...
  <section class="why_section layout_padding">
    <div class="main">
      <div class="cont a-cont" id="a-container">
        <form class="form" id="a-form" action="entrepreneur_Data.php" method="post" enctype="multipart/form-data">
          <h2 class="form_title title">Create Account For Entrepreneur</h2>
